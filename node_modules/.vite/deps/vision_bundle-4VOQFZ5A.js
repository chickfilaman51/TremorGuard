...
function cn(t2) {
  var _a2;
  if (W)
    return (_a2 = t2[q]) != null ? _a2 : t2[q] = /* @__PURE__ */ new Map();
  if (q in t2)
    return t2[q];
    ...
    if (c2) {
      ...
      if (r2) {
        t: {
          ...
          if (o2)
            for (let t3 in o2)
              isNaN(+t3) ? (s2 != null ? s2 : s2 = {})[t3] = o2[t3] : (r2 = o2[t3], Array.isArray(r2) && (ft(r2) || ct(r2) && 0 === r2.size) && (r2 = null), null == r2 && (a2 = true), null != r2 && ((s2 != null ? s2 : s2 = {})[t3] = r2));
          if (a2 || (s2 = o2), s2)
            for (let t3 in s2) {
              a2 = s2;
              break t;
...
function Lo(t2) {
  ...
  if ((e2 = (_d = pn(t2, is, 4)) == null ? void 0 : _d.h()) && (s2.boundingBox = { originX: (_e2 = An(e2, 1)) != null ? _e2 : 0, originY: (_f = An(e2, 2)) != null ? _f : 0, width: (_g = An(e2, 3)) != null ? _g : 0, height: (_h2 = An(e2, 4)) != null ? _h2 : 0, angle: 0 }), (_i2 = pn(t2, is, 4)) == null ? void 0 : _i2.g().length)
    for (const e3 of pn(t2, is, 4).g())
      s2.keypoints.push({ x: (_j = Ze(e3, 1)) != null ? _j : 0, y: (_k = Ze(e3, 2)) != null ? _k : 0, score: (_l = Ze(e3, 4)) != null ? _l : 0, label: (_m = re(ze(e3, 3))) != null ? _m : "" });
  return s2;
}
function Ro(t2) {
  var _a2, _b, _c, _d;
  ...
  for (const n2 of mn(t2, hs, 1))
    e2.push({ x: (_a2 = bn(n2, 1)) != null ? _a2 : 0, y: (_b = bn(n2, 2)) != null ? _b : 0, z: (_c = bn(n2, 3)) != null ? _c : 0, visibility: (_d = bn(n2, 4)) != null ? _d : 0 });
  return e2;
}
function Fo(t2) {
  var _a2, _b, _c, _d;
  ...
  m() {
    ...
    Bi(n2, "mediapipe.tasks.vision.face_landmarker.FaceLandmarkerGraph"), Gi(n2, "IMAGE:image_in"), Gi(n2, "NORM_RECT:norm_rect"), ji(n2, "NORM_LANDMARKS:face_landmarks"), n2.o(e2), zi(t2, n2), this.g.attachProtoVectorListener("face_landmarks", (t3, e3) => {
      ...
      if (this.outputFaceBlendshapes)
        for (const e4 of t3)
          t3 = es(e4), this.j.faceBlendshapes.push(xo((_a2 = t3.g()) != null ? _a2 : []));
      $o(this, e3);
      ...
      if (this.outputFacialTransformationMatrixes)
        for (const e4 of t3)
          (t3 = pn(Cs(e4), us, 2)) && this.j.facialTransformationMatrixes.push({ rows: (_a2 = Tn(An(t3, 1), 0)) != null ? _a2 : 0, columns: (_b = Tn(An(t3, 2), 0)) != null ? _b : 0, data: (_c = en(t3, 3, Ht, tn()).slice()) != null ? _c : [] });
      $o(this, e3);
...
var fh = class extends Za {
  ...
  Ra(t2, e2, n2) {
    ...
    if (this.h = "function" == typeof e2 ? e2 : n2, $a(this, t2, r2 != null ? r2 : {}), !this.h)
      return this.s;
  }
  m() {
    var t2 = new $i();
...
function mh(t2, e2 = true) {
  ...
  for (const i2 of t2) {
    ...
    for (const n3 of r2.g())
      r2 = e2 && null != An(n3, 1) ? Tn(An(n3, 1), 0) : -1, t2.push({ score: (_a2 = bn(n3, 2)) != null ? _a2 : 0, index: r2, categoryName: (_b = kn(n3, 3)) != null ? _b : "", displayName: (_c = kn(n3, 4)) != null ? _c : "" });
    n2.push(t2);
  }
  return n2;
}
var yh = class extends Za {
  ...
  o(t2) {
    ...
    if (xn(this.v, 3, (_a2 = t2.numHands) != null ? _a2 : 1), "minHandDetectionConfidence" in t2 && Ln(this.v, 2, (_b = t2.minHandDetectionConfidence) != null ? _b : 0.5), "minTrackingConfidence" in t2 && Ln(this.s, 4, (_c = t2.minTrackingConfidence) != null ? _c : 0.5), "minHandPresenceConfidence" in t2 && Ln(this.C, 2, (_d = t2.minHandPresenceConfidence) != null ? _d : 0.5), t2.cannedGesturesClassifierOptions) {
      ...
      void 0 === t2.cannedGesturesClassifierOptions && ((_f = pn(this.h, Hs, 3)) == null ? void 0 : _f.g());
    ...
    Bi(n2, "mediapipe.tasks.vision.gesture_recognizer.GestureRecognizerGraph"), Gi(n2, "IMAGE:image_in"), Gi(n2, "NORM_RECT:norm_rect"), ji(n2, "HAND_GESTURES:hand_gestures"), ji(n2, "LANDMARKS:hand_landmarks"), ji(n2, "WORLD_LANDMARKS:world_hand_landmarks"), ji(n2, "HANDEDNESS:handedness"), n2.o(e2), zi(t2, n2), this.g.attachProtoVectorListener("hand_landmarks", (t3, e3) => {
      ...
      for (const e4 of t3) {
        ...
        for (const e5 of mn(t3, hs, 1))
          n3.push({ x: (_a2 = bn(e5, 1)) != null ? _a2 : 0, y: (_b = bn(e5, 2)) != null ? _b : 0, z: (_c = bn(e5, 3)) != null ? _c : 0, visibility: (_d = bn(e5, 4)) != null ? _d : 0 });
    ...
    Bi(n2, "mediapipe.tasks.vision.hand_landmarker.HandLandmarkerGraph"), Gi(n2, "IMAGE:image_in"), Gi(n2, "NORM_RECT:norm_rect"), ji(n2, "LANDMARKS:hand_landmarks"), ji(n2, "WORLD_LANDMARKS:world_hand_landmarks"), ji(n2, "HANDEDNESS:handedness"), n2.o(e2), zi(t2, n2), this.g.attachProtoVectorListener("hand_landmarks", (t3, e3) => {
      ...
      for (const e4 of t3) {
        ...
        for (const e5 of t3.g())
          n4.push({ score: (_a2 = bn(e5, 2)) != null ? _a2 : 0, index: (_b = Tn(An(e5, 1), 0)) != null ? _b : -1, categoryName: (_c = kn(e5, 3)) != null ? _c : "", displayName: (_d = kn(e5, 4)) != null ? _d : "" });
        i2.push(n4);
      }
...
//# sourceMappingURL=vision_bundle-4VOQFZ5A.js.map
